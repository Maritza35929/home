...
class TecnicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tecnico" do
    assert_difference('Tecnico.count') do
      post tecnicos_url, params: { tecnico: { nombre: @tecnico.nombre, profesion_u_oficio: @tecnico.profesion_u_oficio, servicios_ofrecidos: @tecnico.servicios_ofrecidos, telefono: @tecnico.telefono } }
    end
  ...
  test "should update tecnico" do
    patch tecnico_url(@tecnico), params: { tecnico: { nombre: @tecnico.nombre, profesion_u_oficio: @tecnico.profesion_u_oficio, servicios_ofrecidos: @tecnico.servicios_ofrecidos, telefono: @tecnico.telefono } }
